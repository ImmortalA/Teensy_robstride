...
- **`apps/`** – PC/host examples  
  ...
  - `demo_MIT.cpp` – MIT‑only control demo.  
  - `demo_comm_test.cpp` – basic comms test between PC and Teensy.
...
Network assumptions (editable in `apps/main.cpp` and `apps/demo_MIT.cpp`):
